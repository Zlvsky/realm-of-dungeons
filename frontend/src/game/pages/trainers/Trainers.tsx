...
interface IMerchants {
  stage: "trainers" | "single_trainer";
}

function Trainers({ stage }: IMerchants) {
  const [currentTrainer, setCurrentTrainer] = useState("");

  if (stage === "single_trainer" && currentTrainer.length > 0)
    return <TrainerPage currentTrainer={currentTrainer} />;
